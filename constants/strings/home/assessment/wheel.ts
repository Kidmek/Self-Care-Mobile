...
export enum WHEEL_STRINGS_AM {
  ...
  STEP_6 = 'ያለውን ስዕላዊ መግለጫ ከተመለከቱ በኋላ በመግለጫው መሰረት የክቡን አጠቃላይ ቅርፅ እና ሚዛን ማለትም የህይወትዎን ዋና ዋና ክፍሎች ሚዛን ይጠብቁ።',
  STEP_7 = 'በእያንዳንዱ የህይወት ክፍል የሰጡት ነጥብ የክፍል ውጫዊ ጠርዝ ላይ ይታይዎታል',
  STEP_8 = 'ዝቅተኛ ውጤት ያስመዘገቡ ወይም መሻሻል የሚያስፈልጋቸውን የሕይወትህን ዘርፎች ይለዩ።',
  STEP_9 = 'እነዚያን ቦታዎች እንዴት ማሻሻል እንደምትችል ያስቡ እና የበለጠ ሚዛናዊ ህይወትን ለማሳካት ልዩ ግቦችን ያውጡ። (በእነዚያ አካባቢዎች እርካታዎን ወይም እርካታን ለማሻሻል ምን አይነት እርምጃዎችን፣ ለውጦችን ወይም ማስተካከያዎችን ማድረግ እንደሚችሉ ያስቡ።)',
}
export const am_wheel_translations: { [placeholder in WHEEL_STRINGS]?: string } = {
  [WHEEL_STRINGS.SATISFIED_QNS]: 'በዚህ አካባቢ ምን ያህል ረክተዋል?',
  [WHEEL_STRINGS.DESCRIPTION]: 'ማብራሪያ',
  [WHEEL_STRINGS.GUIDELINE]: 'መመሪያ',
  [WHEEL_STRINGS.STEP_1]: 'በክቡ ውስጥ ለተቀመጡት እያንዳንዱ የህይወት ክፍሎች ነጥብ ይስጡ፡፡',
  [WHEEL_STRINGS.STEP_2]: 'ለእያንዳንዱ ክፍል ከ1 እስከ 10 ባለው ሚዛን ነጥብ ይስጡ ወይም 1 ዝቅተኛው እና 10 ከፍተኛው ነው።',
  [WHEEL_STRINGS.STEP_3]: 'የነጥብ አሰጣጡ የሚያመለክተው በዛ የህይወትዎ ክፍል አካባቢ ያለውን የእርካታዎን ደረጃ ነው።',
  [WHEEL_STRINGS.STEP_4]: 'በእያንዳንዱ የህይወት ክፍል የሰጡት ነጥብ የክፍል ውጫዊ ጠርዝ ላይ ይታይዎታል',
  [WHEEL_STRINGS.STEP_5]:
